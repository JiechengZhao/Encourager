...
INSERT INTO "new_Task" ("completed", "description", "dueDate", "id", "name", "parentId", "subDialogId") SELECT "completed", "description", "dueDate", "id", "name", "parentId", "subDialogId" FROM "Task";
DROP TABLE "Task";
