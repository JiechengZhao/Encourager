...
export function OutgoingMessage({ message }: Prop) {
  return (
    <div className="flex mb-4 cursor-pointer">
      ...
      <div className="flex bg-indigo-500 rounded-lg p-3 gap-3">
        <Markdown
  ...
  return (
    <div className="flex mb-4 cursor-pointer">
      ...
      <div className="flex bg-white rounded-lg p-3 gap-3">
        <Markdown remarkPlugins={[remarkGfm, remarkBreaks]} className="text-gray-700">
          {message}
        </Markdown>
        <button
          onClick={copyToClipboard}
          className="p-2 bg-purple-300 rounded-full mr-2"
        >
          <IoMdCopy className="text-white text-xl" />{" "}
